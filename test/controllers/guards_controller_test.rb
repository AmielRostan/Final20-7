...
class GuardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guard" do
    assert_difference('Guard.count') do
      post guards_url, params: { guard: { appointment_date: @guard.appointment_date, medical_center_id: @guard.medical_center_id, worker_id: @guard.worker_id } }
    end
  ...
  test "should update guard" do
    patch guard_url(@guard), params: { guard: { appointment_date: @guard.appointment_date, medical_center_id: @guard.medical_center_id, worker_id: @guard.worker_id } }
