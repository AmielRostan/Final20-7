...
class ClothsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cloth" do
    assert_difference('Cloth.count') do
      post cloths_url, params: { cloth: { brand_id: @cloth.brand_id, clothing_type_id: @cloth.clothing_type_id, color: @cloth.color, description: @cloth.description, name: @cloth.name } }
    end
  ...
  test "should update cloth" do
    patch cloth_url(@cloth), params: { cloth: { brand_id: @cloth.brand_id, clothing_type_id: @cloth.clothing_type_id, color: @cloth.color, description: @cloth.description, name: @cloth.name } }
