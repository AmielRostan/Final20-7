...
class TransmissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transmission" do
    assert_difference('Transmission.count') do
      post transmissions_url, params: { transmission: { date: @transmission.date, person_id: @transmission.person_id, program_number: @transmission.program_number } }
    end
  ...
  test "should update transmission" do
    patch transmission_url(@transmission), params: { transmission: { date: @transmission.date, person_id: @transmission.person_id, program_number: @transmission.program_number } }
